  ...
  >
    ...
    <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
        ...
        <h2 class="mt-4 text-xl font-bold text-white">Summarize Section</h2>

        <p class="mt-1 text-sm text-gray-300">
          This feature enables user to summarize the content of research papers and books in a concise and readable format thus helping them to save time in understanding and reading large volumes of material.
        </p>
      </div>
      ...
      >
        ...
        <h2 class="mt-4 text-xl font-bold text-white">QnA section</h2>
      ...
      >
        ...
        <h2 class="mt-4 text-xl font-bold text-white">Research Efficiency</h2>
